    ...
    if(indexPath.section<2)
    {
        ...
        cell.didSelectedBtn = ^(int tag){
            if(tag==1111)
            {
                ...
                if (_delegate && [_delegate respondsToSelector:@selector(selectCityStr:)]) {
                    [_delegate selectCityStr:weakSelf.currentCityString];
                }
            ...
            else
            {
                ...
                if (_delegate && [_delegate respondsToSelector:@selector(selectCityStr:)]) {
                    [_delegate selectCityStr:weakSelf.hotCityArray[tag]];
                }
            }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(selectCityStr:)]) {
            [_delegate selectCityStr:string];
        }
